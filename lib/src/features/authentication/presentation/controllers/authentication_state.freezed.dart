...
abstract class $AuthenticationStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AuthenticationStatus status, String? accessToken});
}
...
class _$AuthenticationStateImpl implements _AuthenticationState {
  const _$AuthenticationStateImpl({required this.status, this.accessToken});
  ...
  @override
  String toString() {
    return 'AuthenticationState(status: $status, accessToken: $accessToken)';
  }
...
abstract class _AuthenticationState implements AuthenticationState {
  const factory _AuthenticationState(
      ...
      final String? accessToken}) = _$AuthenticationStateImpl;
